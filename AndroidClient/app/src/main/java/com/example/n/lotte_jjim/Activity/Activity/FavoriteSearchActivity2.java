...
public class FavoriteSearchActivity2 extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "FavoriteSearchActivity2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_favorite_search2);
        Init_LocationArray();
